...
**Zorin OS / Linux Kullanıcıları İçin:**
...
| **Tars-Flash** | ~0.45 Cent | Gemini 3 Flash + Nex-N2-Pro + Mimo-V2.5-Pro + Qwen3 Coder Flash | DeepSeek V4 Pro |
| **Tars** | ~1.30 Cent | Gemini 3.5 Flash + Nex-N2-Pro + Mimo-V2.5-Pro + Qwen3 Coder | DeepSeek V4 Pro |
| **Tars-Pro** | ~3.00 - 4.00 Cent | z-ai/glm-5.2 (MAX) + nex-agi/nex-n2-pro (MAX) + Gemini 3.5 Flash + Mimo-V2.5-Pro | DeepSeek V4 Pro |
| **Tars-Ultra** | ~17.00 - 18.00 Cent| Claude Sonnet 5 (Normal) + z-ai/glm-5.2 (MAX) + Gemini 3.5 Flash | DeepSeek V4 Pro |
